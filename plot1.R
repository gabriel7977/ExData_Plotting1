...
# Plot code
# plot1
ggplot(data=household_power_consumption)+geom_histogram(mapping=aes(x=Global_active_power),binwidth = 0.40,fill="red",color="black")+xlab("Global active Power (kilowatts)")+ylab("Frequency")+xlim(0,6)+scale_y_continuous(breaks = seq(0,1200,200))
ggsave("plot1.png")
